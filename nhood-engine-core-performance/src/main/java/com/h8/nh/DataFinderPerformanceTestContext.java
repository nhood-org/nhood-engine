...
public final class DataFinderPerformanceTestContext implements DataFinderTestContext<DataResourceKey, Object> {

    private DataMatrixRepository<DataResourceKey, Object> repository;

    private int registered;

    DataFinderPerformanceTestContext(final int metadataSize) {
